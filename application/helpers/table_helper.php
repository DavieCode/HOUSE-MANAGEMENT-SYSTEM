...
function get_person_data_row($person, $controller)
{
    ...
    $table_data_row.='<td width="5%">' . anchor($controller_name . "/view/$person->person_id/width:$width", $CI->lang->line('common_edit'), array('class' => 'modal_link', 'data-toggle' => 'modal', 'data-target' => '#tenant_modal', 'title' => $CI->lang->line($controller_name . '_update'))) . '</td>';
    $table_data_row.='</tr>';
