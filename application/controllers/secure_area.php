...
class Secure_area extends CI_Controller {
    ...
    function __construct($module_id = null, $submodule_id = null)
    {
        ...
        // if (!$this->staff->has_module_grant($module_id, $staff_id) ||
        //         (isset($submodule_id) && !$this->staff->has_module_grant($submodule_id, $staff_id)))
        // {
        //     redirect('no_access/' . $module_id . '/' . $submodule_id);
        // }

        //load up global data
        $logged_in_staff_info = $this->staff->get_logged_in_staff_info();

        //$data['allowed_modules'] = $this->Module->get_allowed_modules($logged_in_staff_info->person_id);
        
        $data['user_info'] = $logged_in_staff_info;
        //$data['controller_name'] = 'tenants';
